...
namespace BedrockCommunity\level\generator\biome;

use BedrockCommunity\level\generator\ender\biome\EnderBiome;

use pocketmine\level\generator\biome\Biome as BiomePM;
use pocketmine\level\generator\hell\HellBiome;

abstract class Biome extends BiomePM {
