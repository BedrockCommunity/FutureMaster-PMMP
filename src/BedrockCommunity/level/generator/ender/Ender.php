...
namespace BedrockCommunity\level\generator\ender;

use BedrockCommunity\level\generator\biome\Biome;
use BedrockCommunity\level\generator\ender\populator\EnderPilar;
